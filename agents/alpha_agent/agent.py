"""Alpha Agent — autonomous TaskForge competitor.

Baseline invoice-extraction prompt.
...
CLAIM_PORT:      int = int(os.getenv("CLAIM_PORT", "9402"))
...
def main() -> None:
    ...
    print(f"\n{_B}{'='*60}{_X}")
    print(f"{_B}  Alpha Agent  ·  {AGENT_ID}  ·  port {CLAIM_PORT}{_X}")
    print(f"{_B}{'='*60}{_X}\n")
